...
const ProjectsSection = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'A sleek portfolio website showcasing my skills, projects, and journey as a developer. It features a responsive design, smooth animations, and a particle background, with sections for my work and contact info, highlighting my front-end development and UI/UX expertise.',
